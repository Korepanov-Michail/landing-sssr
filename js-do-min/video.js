window.onload = function() {
            ...
            var request = new XMLHttpRequest();
              ...
              request.onreadystatechange = function(){
                ...
                if(request.readyState == 4 && request.status == 200 ){ 
                    ...
                    //регулярное выражение из ответа сервера вырезает всё кроме кирилийы и латиницы
                    document.querySelector('#result').innerHTML = (str.replace(/[^а-яА-Яa-zA-Z]+/gi, " "))

        
                }
              }
            request.open('POST','PHPMailer.php');
  ...
  $(".mail").hover(
  function(){//функция возникающая при входе мыши на элемент 
      $(".mail ").addClass('mail_fieldset_hover');
  },
    function(){//функция возникающая при выходе мыши с элемента 
